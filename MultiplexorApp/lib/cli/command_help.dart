...
const List<CommandHelpGroup> commandHelpGroups = <CommandHelpGroup>[
  ...
  CommandHelpGroup('instance', <String>[
    'list',
    'bulk <start|stop|restart|delete> <name>... [--concurrency <1-8>] [--confirm <token>]',
    'current',
  ...
  CommandHelpGroup('network', <String>[
    'list [--json]',
    'candidates [--json]',
    'recover',
    'create <name> --members <a,b> --default <alias> [--proxy velocity] [--port <port>] [--bind <127.0.0.1|0.0.0.0>] [--fallback <a,b>] [--jar <path>] [--proxy-version <version>] [--offline]',
    'add <name> <instance> [--alias <alias>] [--port <port>]',
    'remove <name> <alias>',
    'configure <name> [--default <alias>] [--fallback <a,b>] [--port <port>] [--bind <127.0.0.1|0.0.0.0>]',
    'delete <name> --confirm <name>',
    'start <name> [--timeout <seconds>]',
    'stop <name>',
    'restart <name> [--timeout <seconds>]',
    'status <name> [--json]',
    'check <name> [--json]',
    'repair <name>',
    'console <name>',
  ...
  CommandHelpGroup('gameplay', <String>[
    ...
    'list [--json]',
    'swarm-profiles [--json]',
    'sessions validate <profile.json> [--instance <name>] [--network <name>] [--prepare] [--json]',
    'sessions start <profile.json> [--instance <name>] [--network <name>] [--prepare] [--start] [--stop-after] [--startup-timeout <seconds>] [--viewer-port <port>] [--no-viewer] [--json]',
    'sessions list [--json]',
    'sessions status <run> [--json]',
    'sessions stop <run> [--json]',
    'sessions resume <run> [--json]',
    'sessions report <run> [--json]',
    'swarm <idle|wander|redstone|workshop|mixed|stress|plan.json> [instance] [--instance <name>] [--bots <1-256>] [--duration <seconds>] [--seed <uint32>] [--join-interval <milliseconds>] [--radius <4-64>] [--prefix <name>] [--build-arena] [--origin <x,y,z>] [--scatter <8-4096>] [--workload <path.json>] [--bounds <minX,minY,minZ:maxX,maxY,maxZ>] [--goals <activity=count,...>] [--completion <duration|goals>] [--chat] [--prepare] [--start] [--stop-after] [--startup-timeout <seconds>] [--connect-timeout <seconds>] [--action-timeout <seconds>] [--version <version>] [--viewer-port <port>] [--no-viewer] [--json]',
